...
<Tabs>
  ...
  <TabItem value="AutoCAD OR Normal Sunrise" label="AutoCAD OR Normal Sunrise">
    AutoCAD: 
    ...
    * Cannons are baited into the deathwall away from the nearest tower.
    ...
    See [Sunrise Sabbath](#sunrise-sabbath) for more details.
  </TabItem>
</Tabs>
...
<Tabs>
  <TabItem value="Witch Hunt" label="Witch Hunt">
    [Witch Hunt Toolbox](https://ff14.toolboxgaming.space/?id=718695171442271&preview=1)

    Baits: Melee in, Ranged Far, supports first.
  </TabItem>
    <TabItem value="Electrope Edge 1" label="Electrope Edge 1">
    [Electrope Edge 1 Raidplan](https://raidplan.io/plan/GDntMfyfYoLU7WCq)

    Boss relative spreads 
  </TabItem>
    <TabItem value="Electrope Edge 2" label="Electrope Edge 2">
    [Electrope Edge 2 Raidplan](https://raidplan.io/plan/YBZukOXIUCmDFM2V)

    Supports left, DPS right. 

    Partner: DPS 2 under the boss, 3 to the side. Support 2 south, 3 north.
  </TabItem>
    <TabItem value="Ion Cannon 1" label="Ion Cannon">
    [Ion Cannon Raidplan](https://raidplan.io/plan/lcutLlTGtmi0MKXY)

    DN static Cannons, supports left, DPS right (Boss relative) 
  </TabItem>
    <TabItem value="Transition" label="Transition">
...
<Tabs>
  <TabItem value="Exaflares" label="Exaflares">
    [Exaflares Raidplan](https://raidplan.io/plan/e7W63yWjXimPUekl)

    Baits: Melee in, Ranged Far, supports first.
  </TabItem>
    <TabItem value="Mustard Bomb" label="Mustard Bomb">
    [Mustard Bomb Raidplan](https://raidplan.io/plan/0Z8Ram6BFLHciLns)

    Square Assignments Tanks Move 
  </TabItem>
    <TabItem value="Midnight Sabath" label="Midnight Sabath">
    [Midnight Sabath Raidplan](https://raidplan.io/plan/L3YWPkM_1NMrNVBM)

    MT/HR pairs (Intercards rotate CCW, Spread: Support CW, DPS CCW) 
  </TabItem>
    <TabItem value="Sunrise Sabath: Wall Baits" label="Sunrise Sabath: Wall Baits">
    [Sunrise Sabath: Wall Baits Raidplan](https://raidplan.io/plan/DGafL6v7CUTkx_5c)
  </TabItem>
    <TabItem value="Sunrise Sabath AutoCAD/Uptime" label="Sunrise Sabath AutoCAD/Uptime">
...
<Tabs>
  <TabItem value="Bewitching Flight" label="Bewitching Flight">
  ...
  <TabItem value="Electrifying Witch Hunt" label="Electrifying Witch Hunt">
  ...
  <TabItem value="Narrowing/Widening Witch Hunt" label="Narrowing/Widening Witch Hunt">
    ...
    The cast bar will indicate the pattern of AoEs the boss will use. "Narrowing" starts with a donut AoE, and "Widening" starts with a point-blank AoE. "Narrow" means start inside, while "Widening" means start outside. The patterns are:
    * Out - In - Out - In
    * In - Out - In - Out
...
<Tabs>
  <TabItem value="Spread" label="Spread" default>
    ...
    - For ranged: Group 1 left, looking at the boss; Group 2 right, looking at the boss. Healers near the cube, Ranged DPS toward the middle edge of the arena.
    - For melee: M1 left max melee, M2 right max melee, MT under the boss, OT at the corner between the two melee.
  </TabItem>
  <TabItem value="Partners" label="Partners">
...
<Tabs>
  <TabItem value="First Debuff Spreads" label="First Debuff Spreads" default>
    ...
    - If you got hit twice, go to the northern corners that are safe. Supports left, DPS right. The twos go there as their debuff will explode the tiles in a 3x3 pattern with the player in the middle.
    - If you got hit three times, go to the southern corners that are safe. Supports left, DPS right. The threes go there as their debuff will explode the tiles in a 5x5 pattern with the player in the middle.
  ...
  <TabItem value="Second Debuff Spreads" label="Second Debuff Spreads">
...
* Near and Far: There are green and blue debuffs with arrows pointing in or out. This debuff will hit a player that is either closest or farthest with a line AoE. Treat both the same.
...
Throughout the transition, she will attack with sets of conal AoEs, alternating between aiming at cardinals/intercardinals and between them for a total of five times.
Stand between the cardinals and intercardinals. Melee/Tanks in front, Ranged/Healers behind.

On the first telegraph, rotate to intercards. Once dodged, rotate back to where you started. Continue to shuffle back and forth, dodging the cones.
...
Next, instead of the normal cones, she will target those same players with a shared damage, wide cone. Because of the vulnerability, these cones act like Wild Charges, so the partners must block for those that have vulnerabilities. The cones are wide, so make sure to be on your intercard.
...
<Tabs>
  <TabItem value="Mustard Bomb" label="Mustard Bomb" default>
  ...
  <TabItem value="Aetherial Conversion" label="Aetherial Conversion">
  ...
  <TabItem value="Wicked Special" label="Wicked Special">
...
<Tabs>
  <TabItem value="Normal Baits" label="Normal Baits" default>
  ...
  <TabItem value="AutoCAD / Uptime" label="AutoCAD / Uptime">
